...
summary: 使用 Amazon EVS 和Amazon FSx for NetApp ONTAP介绍NetApp灾难恢复。在NetApp Disaster Recovery 中添加所有复制计划信息后，请验证您输入的信息是否正确。 
---
= 创建复制计划：步骤 4 - 验证NetApp灾难恢复中的设置
:allow-uri-read: 


[role="lead"]
在NetApp Disaster Recovery 中添加复制计划信息后，请验证您输入的信息是否正确。
